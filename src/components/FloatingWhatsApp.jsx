...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.15)] hover:bg-[#20ba56] hover:-translate-y-1 hover:shadow-[0_6px_16px_rgba(0,0,0,0.2)] transition-all duration-300 group"
    >
      {/* Ícone SVG do WhatsApp Otimizado */}
      <svg
      ...
      {/* Efeito de pulso sutil (ping) que ativa quando passa o mouse, chamando a atenção */}
