      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-10 pb-8 border-b border-indigo-900/50">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="pt-1 text-indigo-200 font-medium space-y-0.5">
              <p>📞 (11) 2155-9845</p>
          ...
          <div className="pt-1 flex items-center gap-4">
            <a 
              href="https://www.linkedin.com/company/devolva-f%C3%A1cil/" 
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="LinkedIn Devolva Fácil"
              className="text-indigo-300 hover:text-white hover:scale-110 transition-all duration-300"
            >
            ...
            <a 
              href="https://www.instagram.com/devolvafaciloficial/" 
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="Instagram Devolva Fácil"
              className="text-indigo-300 hover:text-white hover:scale-110 transition-all duration-300"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pt-3">
            <a 
              href="https://www.google.com/maps/dir//''/data=!4m7!4m6!1m1!4e2!1m2!1m1!1s0x94cf037a356f4225:0xe6b57d52bfae7e99!3e0?g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAMYASAF" 
              target="_blank" 
              rel="noopener noreferrer"
              className="block relative w-full h-24 rounded-lg overflow-hidden border border-indigo-900/50 group"
              aria-label="Ver localização no Google Maps"
            >
              {/* iframe do Google Maps */}
              <iframe 
                title="Mapa de Localização"
                src="https://maps.google.com/maps?q=Av.%20Barueri%20Mirim,%20730,%20Barueri%20-%20SP&t=&z=15&ie=UTF8&iwloc=&output=embed" 
                className="w-full h-full pointer-events-none grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-500"
                loading="lazy"
              ></iframe>
              
              {/* Overlay com botão hover */}
              <div className="absolute inset-0 bg-indigo-950/20 group-hover:bg-transparent transition-colors flex items-center justify-center">
                <span className="bg-[#2D2856]/95 text-white text-[10px] font-bold px-3 py-1.5 rounded-full border border-indigo-500/30 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 shadow-lg">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center text-xs text-indigo-300 font-medium gap-4 text-center lg:text-left">
        ...
        <div className="bg-indigo-950/40 border border-indigo-900/50 px-4 py-2 rounded-lg max-w-2xl">
          <p className="leading-relaxed text-indigo-200">
            <strong>Razão Social:</strong> DEVOLVA FACIL LTDA | <strong>CNPJ:</strong> 10.426.959/0001-47 
          </p>
        </div>
      </div>
    </footer>
